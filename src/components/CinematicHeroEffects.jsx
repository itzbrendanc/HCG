  ...
  return (
    <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      <motion.div
        ...
        animate={prefersReducedMotion ? undefined : { rotate: [0, 8, 0] }}
      ...
      <motion.div
        ...
        animate={prefersReducedMotion ? undefined : { rotate: -360 }}
        transition={prefersReducedMotion ? undefined : { duration: 46, repeat: Infinity, ease: 'linear' }}
      />

      {/* Pulsing blue aura */}
      <motion.div
        className="absolute right-0 top-1/2 h-[520px] w-[520px] -translate-y-1/2 rounded-full bg-hcg-600/10 blur-3xl"
        animate={prefersReducedMotion ? undefined : { opacity: [0.18, 0.30, 0.18] }}
        transition={prefersReducedMotion ? undefined : { duration: 5.6, repeat: Infinity, ease: 'easeInOut' }}
      />
    </div>
  )
}
